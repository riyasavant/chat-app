...
function login() {
  ...
  // const content =()=>{
  //   const message =["Secure","Fast","Easy to use"];
  //   let i =0 ;
  //   let jsxArray = [];
  //   for(i=0; i<message.length;i++){
  //     jsxArray.push(
  //       <p id="desc">{message[i]}</p>
  //      );
  //   }
  //   return jsxArray;
  // }
  ...
  return (
    ...
    <div className="credentials">
      <form>
        <p id="new-user">
          New User? <span id="reg">Register</span>
        </p>
